  ...
  return (
    <nav className={`container ${ sticky? 'dark-nav': '' }`}>
     ...
     <ul className={mobilemenu? '':'hide-mobile-icon'}>
        ...
        <li><Link to="heros" smooth={true} duration={500} offset={-260}>Home</Link></li>
        ...
        <li> <Link to="contact"  className='btn' smooth={true} duration={500} offset={-260}>Contact Us</Link></li>
    </ul> 
